...
## sync2 UI fix
- 러닝화 추천의 `전체 검색 / 첫 러닝화 / 정밀 추천` 탭을 모바일에서도 정확히 3등분했습니다.
- 가로 스크롤과 오른쪽 잘림 현상을 제거했습니다.
- 배포 캐시 무효화를 위해 CSS/JS 버전을 `20260711-sync2`로 갱신했습니다.


## Weather V1
- Netlify 환경 변수: `KMA_API_KEY`
- Function: `netlify/functions/weather.js`
- 현재 위치 또는 주요 도시 선택
- 기상청 현재 실황/단기예보와 러닝 적합도 표시
